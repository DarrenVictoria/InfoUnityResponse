...
const districtData = {
  ...
  const PreLocationSelector = ({ 
    ...
    // Trigger location change when component mounts or when initial values change
    useEffect(() => {
        if (initialDistrict) {
            setSelectedDistrict(initialDistrict);
            
            // If initial division is provided and belongs to the initial district, set it
            if (initialDivision && districtData[initialDistrict]?.includes(initialDivision)) {
                setSelectedDivision(initialDivision);
            }

            // Always call onLocationChange with current values
            onLocationChange(initialDistrict, initialDivision);
        }
    }, [initialDistrict, initialDivision]);
...
export default PreLocationSelector;